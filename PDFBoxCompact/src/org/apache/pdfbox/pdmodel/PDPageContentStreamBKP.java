 ...
 */
public final class PDPageContentStreamBKP implements Closeable
{
    ...
    private static final Log LOG = LogFactory.getLog(PDPageContentStreamBKP.class);
     ...
     */
    public PDPageContentStreamBKP(PDDocument document, PDPage sourcePage) throws IOException
    {
     ...
     * @throws IOException If there is an error writing to the page contents.
     * @deprecated use {@link #PDPageContentStream(PDDocument, PDPage, PDPageContentStreamBKP.AppendMode, boolean)}
     */
    @Deprecated
    public PDPageContentStreamBKP(PDDocument document, PDPage sourcePage, boolean appendContent,
     ...
     * {@link #PDPageContentStream(PDDocument, PDPage, PDPageContentStreamBKP.AppendMode, boolean, boolean)}
     ...
     * @throws IOException If there is an error writing to the page contents.
     */
    public PDPageContentStreamBKP(PDDocument document, PDPage sourcePage, AppendMode appendContent,
                               boolean compress) throws IOException
    {
        this(document, sourcePage, appendContent, compress, false);
    }
     ...
     * @throws IOException If there is an error writing to the page contents.
     * @deprecated use {@link #PDPageContentStream(PDDocument, PDPage, PDPageContentStreamBKP.AppendMode, boolean, boolean) }
     */
    @Deprecated
    public PDPageContentStreamBKP(PDDocument document, PDPage sourcePage, boolean appendContent,
     ...
     * @throws IOException If there is an error writing to the page contents.
     */
    public PDPageContentStreamBKP(PDDocument doc, PDAppearanceStream appearance) throws IOException
    {
     ...
     * @throws IOException If there is an error writing to the page contents.
     */
    public PDPageContentStreamBKP(PDDocument doc, PDAppearanceStream appearance, OutputStream outputStream)
            throws IOException
    {
        this.document = doc;
     ...
     * @throws IOException If there is an error writing to the page contents.
     */
    public PDPageContentStreamBKP(PDDocument doc, PDFormXObject form, OutputStream outputStream)
            throws IOException
    {
        this.document = doc;
     ...
     * @throws IOException If there is an error writing to the page contents.
     */
    public PDPageContentStreamBKP(PDDocument doc, PDTilingPattern pattern, OutputStream outputStream)
            throws IOException
    {
        this.document = doc;
