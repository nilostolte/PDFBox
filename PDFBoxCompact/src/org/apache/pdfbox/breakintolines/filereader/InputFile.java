...
import org.apache.pdfbox.breakintolines.list.FastByteArrayList;
 ...
 * when the cycle starts over. The number of blanks skipped is maintained, in 
 * case an exact copy of the file is required. <br>
 * <br>
 * This class is supposed to be accessed through the interface
 * <b><i>Input</i></b> to be able to scan different sources of bytes. The public
 * methods of this class are the following:<br>
 * <br>
 *
 * <ul>
